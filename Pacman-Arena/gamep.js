...
function startGame() {
    myGamePiece = new component(60, 60, "pacman.png", 900, 420, "image");
    myScore = new component("50px", "Consolas", "white", 6, 40, "text");
...
function updateGameArea() {
   ...
   //generazioen palline
    ...
    if (myGameArea.frameNo == 1 || everyinterval(10)) {
        ...
        pall1.push(new component(20, 20, "pg.png", x, y, "image"));
    }
  ...
  if(myGameArea.frameNo>1000){
    if (myGameArea.frameNo == 1 || everyinterval(2010)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        pall2.push(new component(30, 30, "pe.png", x, y, "image"));
    }
  }
  ...
  if(myGameArea.frameNo>500){
    if (myGameArea.frameNo == 1 || everyinterval(510)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta1.push(new component(45, 45, "frutta1.png", x, y, "image"));
    }
  }
  ...
  if(myGameArea.frameNo>700){
    if (myGameArea.frameNo == 1 || everyinterval(710)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta2.push(new component(45, 45, "frutta2.png", x, y, "image"));
    }
  }
  ...
  if(myGameArea.frameNo>900){
    if (myGameArea.frameNo == 1 || everyinterval(910)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta3.push(new component(45, 45, "frutta3.png", x, y, "image"));
    }
  }
  ...
  if(myGameArea.frameNo>1200){
    if (myGameArea.frameNo == 1 || everyinterval(1210)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta4.push(new component(45, 45, "frutta4.png", x, y, "image"));
    }
  }
  if(myGameArea.frameNo>2000){
    if (myGameArea.frameNo == 1 || everyinterval(2010)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta5.push(new component(45, 45, "frutta5.png", x, y, "image"));
    }
  }
  ...
  if(myGameArea.frameNo>3000){
    if (myGameArea.frameNo == 1 || everyinterval(2910)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta6.push(new component(45, 45, "frutta6.png", x, y, "image"));
    }
  }
  ...
  if(myGameArea.frameNo>4000){
    if (myGameArea.frameNo == 1 || everyinterval(3910)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta7.push(new component(45, 45, "frutta7.png", x, y, "image"));
    }
  }
  ...
  if(myGameArea.frameNo>5000){
    if (myGameArea.frameNo == 1 || everyinterval(5110)) {
        ...
        x = myGameArea.canvas.width - num2;
        y = myGameArea.canvas.height - num;
        frutta8.push(new component(45, 45, "frutta8.png", x, y, "image"));
    }
  }
    ...
    if (myGameArea.frameNo == 1 || everyinterval(190)) {
        ...
        y = myGameArea.canvas.height - num;
        fantasmi.push(new component(60, 60, "fr.png", x, y, "image"));
    }
    ...
    if (myGameArea.frameNo == 1 || everyinterval(230)) {
        ...
        y = myGameArea.canvas.height - num;
        fantasmii.push(new component(60, 60, "frr.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>950){
        ...
        x = myGameArea.canvas.width -1;
        y = myGameArea.canvas.height - num;
        fantasmi2.push(new component(60, 60, "fa.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>1110){
        ...
        x = myGameArea.canvas.width -2100;
        y = myGameArea.canvas.height - num;
        fantasmii2.push(new component(60, 60, "faa1.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>1211){
        ...
        x = myGameArea.canvas.width -1;
        y = myGameArea.canvas.height - num;
        fantasmi3.push(new component(60, 60, "fv.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>1311){
        ...
        x = myGameArea.canvas.width -2100;
        y = myGameArea.canvas.height - num;
        fantasmii3.push(new component(60, 60,"fvv.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>2000){
        ...
        y = myGameArea.canvas.height - num;
        fantasmi4.push(new component(60, 60, "fb.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>2300){
        ...
        fantasmi5.push(new component(60, 60, "fz.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>2300){
        ...
        fantasmii5.push(new component(60, 60, "fzz.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>2600){
        ...
        x = myGameArea.canvas.width -num2;
        y = myGameArea.canvas.height - 1;
        fantasmi6.push(new component(60, 60, "fc.png", x, y, "image"));
    }
    }
    ...
    if(myGameArea.frameNo>2600){
        ...
        x = myGameArea.canvas.width -num2;
        y = myGameArea.canvas.height - 1200;
        fantasmii6.push(new component(60, 60, "fcc2.png", x, y, "image"));
    }
    }
    if(myGameArea.frameNo>3000){
    if (myGameArea.frameNo == 1 || everyinterval(310)) {
        ...
        x = myGameArea.canvas.width -1;
        y = myGameArea.canvas.height - num;
        fantasmi7.push(new component(60, 60, "fr.png", x, y, "image"));
    }
    }
    if(myGameArea.frameNo>3000){
    if (myGameArea.frameNo == 1 || everyinterval(340)) {
        ...
        y = myGameArea.canvas.height - num;
        fantasmii7.push(new component(60, 60, "fr.png", x, y, "image"));
    }
}
...
if(myGameArea.frameNo>3500){
    if (myGameArea.frameNo == 1 || everyinterval(540)) {
        ...
        y = myGameArea.canvas.height - num;
        fantasmi8.push(new component(60, 60, "far.png", x, y, "image"));
    }
}
...
if(myGameArea.frameNo>3500){
    if (myGameArea.frameNo == 1 || everyinterval(540)) {
        ...
        x = myGameArea.canvas.width -2100;
        y = myGameArea.canvas.height - num;
        fantasmii8.push(new component(60, 60, "far.png", x, y, "image"));
    }
}
...
if(myGameArea.frameNo>4000){
    if (myGameArea.frameNo == 1 || everyinterval(340)) {
        ...
        x = myGameArea.canvas.width -61;
        y = myGameArea.canvas.height - num;
        fantasmi9.push(new component(60, 60, "fvi.png", x, y, "image"));
    }
}
...
if(myGameArea.frameNo>5000){
    if (myGameArea.frameNo == 1 || everyinterval(20)) {
        ...
        x = myGameArea.canvas.width -61;
        y = myGameArea.canvas.height - num;
        fantasmi10.push(new component(60, 60, "fg.png", x, y, "image"));
